...
public class DataActivity extends AppCompatActivity {
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(DataActivity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                mAdapter = new AdapterData(DataActivity.this, data);
                mRVFishPrice.setAdapter(mAdapter);
                mRVFishPrice.setLayoutManager(new LinearLayoutManager(DataActivity.this));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem itemToHide = menu.findItem(R.id.action_recycler2);
